    ...
    if (!this.pool) {
      try {
        ...
        if (error instanceof Error) {
          ...
          throw new Error("Unable to connect to PostgreSQL database: " + error.message, {cause: error});
        }
      }
    }
  }
    ...
    if (this.pool) {
      try {
        ...
        if (error instanceof Error) {
          ...
          throw new Error("Unable to disconnect from PostgreSQL database: " + error.message, {cause: error});
        }
      }
    }
  }
