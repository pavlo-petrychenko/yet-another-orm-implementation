    ...
    if (this.pool) {
      try {
        ...
        if (error instanceof Error) {
          ...
          throw new Error("Unable to disconnect from MySQL database: " + error.message, {cause: error});
        }
      }
    }
  }
    ...
    if (!this.pool) {
      try {
        ...
        if (error instanceof Error) {
          ...
          throw new Error("Unable to connect to MySQL database: " + error.message, {cause: error});
        }
      }
    }
  }
